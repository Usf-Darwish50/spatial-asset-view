...
export const assets: Asset[] = [
  { id: "a1", name: "HVAC Unit A1", type: "HVAC", status: "working", shape: "circle", image: "/placeholder.svg", description: "Main HVAC unit for ground floor east wing", buildingId: "b1", floorId: "f1", x: 150, y: 200, lastUpdated: "2025-03-28T14:30:00Z", updatedBy: "John Smith", comments: [{ id: "c1", text: "Annual maintenance completed", author: "John Smith", timestamp: "2025-03-28T14:30:00Z" }] },
  { id: "a2", name: "Fire Alarm Panel", type: "Safety", status: "working", shape: "circle", image: "/placeholder.svg", description: "Central fire alarm control panel", buildingId: "b1", floorId: "f1", x: 400, y: 120, lastUpdated: "2025-03-25T09:15:00Z", updatedBy: "Jane Doe", comments: [] },
  { id: "a3", name: "Server Rack 01", type: "IT Equipment", status: "down", shape: "circle", image: "/placeholder.svg", description: "Primary server rack - network closet", buildingId: "b1", floorId: "f1", x: 600, y: 350, lastUpdated: "2025-03-29T16:45:00Z", updatedBy: "Mike Johnson", comments: [{ id: "c2", text: "Power supply failure detected. Replacement ordered.", author: "Mike Johnson", timestamp: "2025-03-29T16:45:00Z", statusChange: { from: "working", to: "down" } }] },
  { id: "a4", name: "Elevator A", type: "Transport", status: "maintenance", shape: "circle", image: "/placeholder.svg", description: "East wing passenger elevator", buildingId: "b1", floorId: "f1", x: 300, y: 450, lastUpdated: "2025-03-27T11:00:00Z", updatedBy: "Sarah Lee", comments: [{ id: "c3", text: "Scheduled maintenance - expected completion 03/30", author: "Sarah Lee", timestamp: "2025-03-27T11:00:00Z", statusChange: { from: "working", to: "maintenance" } }] },
  { id: "a5", name: "Security Camera N1", type: "Security", status: "working", shape: "circle", image: "/placeholder.svg", description: "North entrance surveillance camera", buildingId: "b1", floorId: "f1", x: 100, y: 80, lastUpdated: "2025-03-20T08:00:00Z", updatedBy: "Jane Doe", comments: [] },
  { id: "a6", name: "UPS Unit B", type: "Electrical", status: "working", shape: "circle", image: "/placeholder.svg", description: "Backup power supply unit B", buildingId: "b1", floorId: "f1", x: 550, y: 180, lastUpdated: "2025-03-22T13:20:00Z", updatedBy: "John Smith", comments: [] },
  { id: "a7", name: "Pipe Box W1", type: "Pipe Box", status: "working", shape: "rectangle", image: "/placeholder.svg", description: "Main water pipe distribution box", buildingId: "b1", floorId: "f1", x: 700, y: 500, lastUpdated: "2025-03-18T10:00:00Z", updatedBy: "Mike Johnson", comments: [] },
  { id: "a8", name: "Generator G1", type: "Electrical", status: "working", shape: "circle", image: "/placeholder.svg", description: "Emergency backup generator", buildingId: "b1", floorId: "f1", x: 800, y: 300, lastUpdated: "2025-03-15T09:30:00Z", updatedBy: "John Smith", comments: [] },
  { id: "a9", name: "HVAC Unit B2", type: "HVAC", status: "down", shape: "circle", image: "/placeholder.svg", description: "Floor 1 HVAC - west wing", buildingId: "b1", floorId: "f2", x: 200, y: 250, lastUpdated: "2025-03-29T08:00:00Z", updatedBy: "Sarah Lee", comments: [{ id: "c4", text: "Compressor failure", author: "Sarah Lee", timestamp: "2025-03-29T08:00:00Z", statusChange: { from: "working", to: "down" } }] },
